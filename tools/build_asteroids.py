...
SHIP_SHAPES = [
    # Dir 0 (N): solid triangle pointing up, 7 wide × 5 tall
    [
        (0,-3),
        (-1,-2), (0,-2), (1,-2),
        (-2,-1), (-1,-1), (0,-1), (1,-1), (2,-1),
    ...
    # Dir 1 (NE): solid filled triangle pointing upper-right
    [
        (2,-3), (3,-3), (4,-3),
        (1,-2), (2,-2), (3,-2),
        (0,-1), (1,-1), (2,-1), (3,-1),
    ...
    # Dir 2 (E): solid triangle pointing right, 7 tall × 5 wide
    [
        (3,0),
        (2,-1), (2,0), (2,1),
        (1,-2), (1,-1), (1,0), (1,1), (1,2),
    ...
    # Dir 3 (SE): solid filled triangle pointing lower-right
    [
        (2,3), (3,3), (4,3),
        (1,2), (2,2), (3,2),
        (0,1), (1,1), (2,1), (3,1),
    ...
    # Dir 4 (S): solid triangle pointing down, 7 wide × 5 tall
    [
        (0,3),
        (-1,2), (0,2), (1,2),
        (-2,1), (-1,1), (0,1), (1,1), (2,1),
    ...
    # Dir 5 (SW): solid filled triangle pointing lower-left
    [
        (-2,3), (-3,3), (-4,3),
        (-1,2), (-2,2), (-3,2),
        (0,1), (-1,1), (-2,1), (-3,1),
    ...
    # Dir 6 (W): solid triangle pointing left, 7 tall × 5 wide
    [
        (-3,0),
        (-2,-1), (-2,0), (-2,1),
        (-1,-2), (-1,-1), (-1,0), (-1,1), (-1,2),
    ...
    # Dir 7 (NW): solid filled triangle pointing upper-left
    [
        (-2,-3), (-3,-3), (-4,-3),
        (-1,-2), (-2,-2), (-3,-2),
        (0,-1), (-1,-1), (-2,-1), (-3,-1),
