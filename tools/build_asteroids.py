...
SHIP_SHAPES = [
    # Dir 0 (N): solid triangle pointing up, 7 wide at base, 4 rows
    [
        (0,-3),
        (-1,-2), (0,-2), (1,-2),
        (-2,-1), (-1,-1), (0,-1), (1,-1), (2,-1),
    ...
    # Dir 1 (NE): solid triangle pointing upper-right, chunky diagonal
    [
        (3,-4), (4,-4), (4,-3), (3,-3),
        (2,-3), (2,-2), (3,-2),
        (1,-2), (1,-1), (2,-1),
    ...
    # Dir 2 (E): solid triangle pointing right, 7 tall at base, 4 cols
    [
        (3,0),
        (2,-1), (2,0), (2,1),
        (1,-2), (1,-1), (1,0), (1,1), (1,2),
    ...
    # Dir 3 (SE): solid triangle pointing lower-right, chunky diagonal
    [
        (3,4), (4,4), (4,3), (3,3),
        (2,3), (2,2), (3,2),
        (1,2), (1,1), (2,1),
    ...
    # Dir 4 (S): solid triangle pointing down, 7 wide at base, 4 rows
    [
        (0,3),
        (-1,2), (0,2), (1,2),
        (-2,1), (-1,1), (0,1), (1,1), (2,1),
    ...
    # Dir 5 (SW): solid triangle pointing lower-left, chunky diagonal
    [
        (-3,4), (-4,4), (-4,3), (-3,3),
        (-2,3), (-2,2), (-3,2),
        (-1,2), (-1,1), (-2,1),
    ...
    # Dir 6 (W): solid triangle pointing left, 7 tall at base, 4 cols
    [
        (-3,0),
        (-2,-1), (-2,0), (-2,1),
        (-1,-2), (-1,-1), (-1,0), (-1,1), (-1,2),
    ...
    # Dir 7 (NW): solid triangle pointing upper-left, chunky diagonal
    [
        (-3,-4), (-4,-4), (-4,-3), (-3,-3),
        (-2,-3), (-2,-2), (-3,-2),
        (-1,-2), (-1,-1), (-2,-1),
