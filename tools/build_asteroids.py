...
SHIP_SHAPES = [
    # Dir 0 (N): solid triangle pointing up, 7 wide at base
    [
        (0,-3),
        (-1,-2), (0,-2), (1,-2),
        (-2,-1), (-1,-1), (0,-1), (1,-1), (2,-1),
    ...
    # Dir 1 (NE): solid triangle pointing upper-right
    [
        (2,-3), (3,-3),
        (1,-2), (2,-2), (3,-2),
        (0,-1), (1,-1), (2,-1),
    ...
    # Dir 2 (E): solid triangle pointing right, 7 tall at base
    [
        (3,0),
        (2,-1), (2,0), (2,1),
        (1,-2), (1,-1), (1,0), (1,1), (1,2),
    ...
    # Dir 3 (SE): solid triangle pointing lower-right
    [
        (3,2), (3,3),
        (2,1), (2,2), (2,3),
        (1,0), (1,1), (1,2),
    ...
    # Dir 4 (S): solid triangle pointing down, 7 wide at base
    [
        (0,3),
        (-1,2), (0,2), (1,2),
        (-2,1), (-1,1), (0,1), (1,1), (2,1),
    ...
    # Dir 5 (SW): solid triangle pointing lower-left
    [
        (-2,3), (-3,3),
        (-1,2), (-2,2), (-3,2),
        (0,1), (-1,1), (-2,1),
    ...
    # Dir 6 (W): solid triangle pointing left, 7 tall at base
    [
        (-3,0),
        (-2,-1), (-2,0), (-2,1),
        (-1,-2), (-1,-1), (-1,0), (-1,1), (-1,2),
    ...
    # Dir 7 (NW): solid triangle pointing upper-left
    [
        (-3,-2), (-3,-3),
        (-2,-1), (-2,-2), (-2,-3),
        (-1,0), (-1,-1), (-1,-2),
