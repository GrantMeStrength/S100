...
export const emulator_disableDiskTrace: (a: number) => void;
export const emulator_enableDiskTrace: (a: number) => void;
...
export const emulator_getDiskTrace: (a: number) => [number, number];
...
export const emulator_setJoystickState: (a: number, b: number) => void;
export const emulator_setJoystickState2: (a: number, b: number) => void;
